  ...
  this.startVisualization = function (element) {
    ...
    */
    if (this.preferences.inherit) {
      console.log('vis width', this.container.offsetWidth);
      console.log('pref width', this.preferences.width);
      this.preferences.width = this.container.offsetWidth ? this.container.offsetWidth : this.preferences.width;
      this.preferences.height = this.container.offsetHeight ? this.container.offsetHeight : this.preferences.height;
    }
